...
# ============================================================
    ...
    if screening is None:
        ...
        TIER_MESSAGE = {
            "양호": (
                "오늘 측정된 패턴은 양호한 범위입니다. "
                "평소 습관을 유지해 보세요."
            ),
            "주의": (
                "평소와 다소 차이가 있는 패턴이 관찰됩니다. 컨디션이나 "
                "수면 등의 영향일 수 있으니, 다음에 한 번 더 확인해 "
                "보시는 걸 권합니다."
            ),
            "확인 권장": (
                "평소와 뚜렷한 차이가 있는 패턴이 관찰됩니다. 정확한 "
                "확인을 위해 신경과·정신건강의학과 또는 치매안심센터 "
                "방문을 고려해 보세요."
            ),
        }
        ...
        st.caption(
            f"참고용 종합 점수: {risk_score:.1f} / 100 "
            "(절대적 정상·비정상 판정이 아닌 참고 수치입니다)"
        )
