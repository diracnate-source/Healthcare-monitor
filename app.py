...
# WebRTC 연결 설정
#
# STUN만 쓰면 Streamlit Cloud 등 일부 클라우드 환경에서 UDP가
# 막혀 연결이 영원히 재시도되며 앱이 멈추는 경우가 보고되어 있다.
# TCP로도 우회 가능한 공용 TURN 서버를 폴백으로 함께 등록한다.
# (아래 TURN 자격증명은 Open Relay Project가 배포하는 공개
# 테스트용 값이다.)
# ============================================================
